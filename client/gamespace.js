class gamespace{
  constructor(board, id, type, x, y){
    ...
    this.me.x = (x+this.offsetR)*this.myscale*this.app.stage.scale.x;
    this.me.y = (y+this.offsetC)*this.myscale*this.app.stage.scale.y;
  
    // // PI / 4
    this.app.stage.x = -this.offsetC*this.myscale*this.app.stage.scale.x;
    this.app.stage.y = -this.offsetR*this.myscale*this.app.stage.scale.x;
