...
class player extends THING {  
  constructor(){
    ...
    this.keycodes["Numpad8"] = "MOVE.N"; 
    this.keycodes["Numpad9"] = "MOVE.NE";
    this.keycodes["Numpad6"] = "MOVE.E";
    this.keycodes["Numpad3"] = "MOVE.SE"; 
    this.keycodes["Numpad2"] = "MOVE.S";  
    this.keycodes["Numpad1"] = "MOVE.SW"; 
    this.keycodes["Numpad4"] = "MOVE.W";
    this.keycodes["KeyQ"] = "MOVE.NW";
    this.keycodes["KeyW"] = "MOVE.N"; 
    this.keycodes["KeyE"] = "MOVE.NE";
    this.keycodes["KeyD"] = "MOVE.E";
    this.keycodes["KeyC"] = "MOVE.SE"; 
    this.keycodes["KeyX"] = "MOVE.S";  
    this.keycodes["KeyZ"] = "MOVE.SW"; 
    this.keycodes["KeyA"] = "MOVE.W";
